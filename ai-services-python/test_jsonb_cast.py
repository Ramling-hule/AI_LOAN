...
async def run():
    ...
    await execute("UPDATE loans SET underwriting_assessment = ($1::text)::jsonb WHERE id = 'a7a61b06-67f4-4659-bc06-e8f806303a12'", test_str)
    ...
    print(f"When passing test_str to ($1::text)::jsonb -> Type: {row['jt']}, Content: {row['underwriting_assessment']}")
